...
public class HipaaPixSyncAdapter extends AbstractSyncAdapter {
	private static final String SYNC_ADAPTER_TAG = "HIPAAPIX_HELPER";

	public static final String HELPER_FLAG_ID = "HIPAAPIX_HELPER";
	public static final String SYNC_STARTED_FLAG_ID = "HIPAAPIX_SYNC_START";

	public static final String SYNC_FINISHED_FLAG_ID = "HIPAAPIX_SYNC_FINISHED";

	public HipaaPixSyncAdapter(Context context, boolean autoInitialize) {
