...
public class HipaapixContentProvider extends ContentProvider {
	...
	private static final String DATABASE_NAME = "hipaapix";

	public static final String AUTHORITY = "swipe.android.hipaapix";

	private static final String BASE_PATH = "hipaapix";
